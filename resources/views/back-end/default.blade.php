...
<head>
    ...
    <link rel="stylesheet" href="{{ url('assets/css/vendor/fullcalendar.min.css')}}" />
    ...
    <link rel="stylesheet" href="{{ url('assets/css/vendor/bootstrap-stars.css')}}" />
    <link rel="stylesheet" href="{{ url('assets/css/vendor/nouislider.min.css')}}" />
    ...
    <div class="navbar-right">
        ...
        <div class="user d-inline-block">
            <button class="btn btn-empty p-0" type="button" data-toggle="dropdown" aria-haspopup="true"
                ...
                <span>
                        <img alt="Profile Picture" src="{{url('assets/img/profile-pic-l.jpg')}}" />
                    </span>
            </button>
                        ...
                        <div class="scroll dashboard-list-with-thumbs">
                            <div class="d-flex flex-row mb-3">
                                <a class="d-block position-relative" href="#">
                                    <img src="{{url('assets/img/marble-cake-thumb.jpg')}}" alt="Marble Cake"
                            ...
                            <div class="d-flex flex-row mb-3">
                                <a class="d-block position-relative" href="#">
                                    <img src="{{url('assets/img/fruitcake-thumb.jpg')}}" alt="Fruitcake"
                                         class="list-thumbnail border-0" />
                                    <span
                                        class="badge badge-pill badge-theme-2 position-absolute badge-top-right">NEW</span>
                                </a>
                            ...
                            <div class="d-flex flex-row mb-3">
                                <a class="d-block position-relative" href="#">
                                    <img src="{{url('assets/img/chocolate-cake-thumb.jpg')}}" alt="Chocolate Cake"
                                         class="list-thumbnail border-0" />
                                    <span
                            ...
                            <div class="d-flex flex-row mb-3">
                                <a class="d-block position-relative" href="#">
                                    <img src="{{url('assets/img/fat-rascal-thumb.jpg')}}" alt="Fat Rascal"
                                         class="list-thumbnail border-0" />
                                    <span
                            ...
                            <div class="d-flex flex-row mb-3">
                                <a class="d-block position-relative" href="#">
                                    <img src="{{url('assets/img/streuselkuchen-thumb.jpg')}}" alt="Streuselkuchen"
                                         class="list-thumbnail border-0" />
                                    <span
                                        class="badge badge-pill badge-theme-3 position-absolute badge-top-right">DONE</span>
                                </a>
                            ...
                            <div class="d-flex flex-row mb-3">
                                <a class="d-block position-relative" href="#">
                                    <img src="{{url('assets/img/cremeschnitte-thumb.jpg')}}" alt="Cremeschnitte"
                                         class="list-thumbnail border-0" />
                                    <span
                                        class="badge badge-pill badge-theme-3 position-absolute badge-top-right">DONE</span>
                                </a>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="scroll dashboard-list-with-user">
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src="{{url('assets/img/profile-pic-l.jpg')}}" alt="Mayra Sibley"
                            ...
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src="{{url('assets/img/profile-pic-l-7.jpg')}}" alt="Mimi Carreira"
                                         class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                </a>
                                <div class="pl-3">
                                    <a href="#">
                            ...
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src="{{url('assets/img/profile-pic-l-6.jpg')}}" alt="Philip Nelms"
                                         class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                </a>
                                <div class="pl-3">
                                    <a href="#">
                            ...
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src="{{url('assets/img/profile-pic-l-3.jpg')}}" alt="Terese Threadgill"
                                         class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                </a>
                                <div class="pl-3">
                                    <a href="#">
                            ...
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src="{{url('assets/img/profile-pic-l-5.jpg')}}" alt="Kathryn Mengel"
                                         class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                </a>
                                <div class="pl-3">
                                    <a href="#">
                            ...
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src="{{url('assets/img/profile-pic-l-4.jpg')}}" alt="Esperanza Lodge"
                                         class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                </a>
                                <div class="pl-3">
                                    <a href="#">
                    ...
                    <div class="card-body">
                        ...
                        <div class="owl-container">
                            <div class="owl-carousel best-rated-items">
                                <div>
                                    <img src="{{url('assets/img/carousel-1.jpg')}}" alt="Cheesecake" class="mb-4">
                                    <h6 class="mb-1">
                                ...
                                <div>
                                    <img src="{{url('assets/img/carousel-2.jpg')}}" alt="Chocolate Cake" class="mb-4">
                                    <h6 class="mb-1">
                                ...
                                <div>
                                    <img src="{{url('assets/img/carousel-3.jpg')}}" alt="Cremeschnitte" class="mb-4">
                                    <h6 class="mb-1">
